...
export const alternativesEntries: AlternativesEntry[] = [
  ...
  },
  {
    ...
    comparisonRows: [
      ...
      },
      {
        ...
        easeOfUseText: "Yes — free Starter tier (800 credits/month)",
        pricing: "Free Starter tier; Professional from $49/month (per Vizcom's own site)",
      },
      {
        slug: "promeai",
      ...
      },
      {
        ...
        easeOfUseText: "No — no free plan or trial (per ArchiGPT's own site)",
    ...
    comparisonRows: [
      {
        ...
        easeOfUseText: "From $47.90/month (Solo plan)",
        pricing: "From $47.90/month (Solo plan, per Chaos's own site)",
      },
      {
        slug: "twinmotion-ai",
      ...
      },
      {
        ...
        easeOfUseText: "From $29/month (annual); free trial available",
        pricing: "From $29/month (annual) or $59/month (monthly); free trial (30 renders, 15 days)",
      },
      {
        slug: "chaos-vantage",
        ...
        easeOfUseText: "Not sold standalone — bundled with V-Ray/Corona Collection",
        pricing: "Not sold standalone — bundled with the V-Ray Collection (~$237/month) or Corona Collection (~$225/month)",
      },
    ],
    lastUpdated: "2026-07-22",
  },
  {
    ...
    comparisonRows: [
      ...
      },
      {
        ...
        workflowText: "No",
        easeOfUseText: "Free Basic tier available",
        pricing: "Free Basic tier (5 users/3 projects); Pro from $39/user/month (annual, per Fieldwire's own site)",
      },
      {
        slug: "open-space",
        ...
        easeOfUseText: "No public price list",
        pricing: "Custom, based on annual construction volume — no public price list (per OpenSpace's own site)",
      },
      {
        slug: "doxel",
        ...
        easeOfUseText: "Not publicly listed",
        pricing: "Not publicly listed — enterprise, contact for demo/quote (per Doxel's own site)",
      },
      {
        slug: "alice-technologies",
  ...
  },
  {
    ...
    comparisonRows: [
      {
        slug: "collov-ai",
        styleRange: "~10 seconds (per Collov's own site)",
        ...
        easeOfUseText: "From $19/month (Standard, 60 credits)",
        pricing: "From $19/month (Standard, 60 credits, per Collov's own site)",
      },
      {
        slug: "homedesigns",
        styleRange: "Minutes",
      ...
      },
      {
        ...
        easeOfUseText: "Free tier available",
        pricing: "Free tier available; Pro from $19/month (annual) or $35/month (monthly), per AI Home Design's own site",
      },
      {
        slug: "dehome",
        ...
        easeOfUseText: "One-time credit packs, not subscription",
        pricing: "One-time credit packs from $9.99 (100 images), not subscription-based, per Dehome's own site",
      },
      {
        slug: "instantdeco-ai",
        styleRange: "Seconds",
        ...
        easeOfUseText: "From $10/month (Basic, annual)",
        pricing: "From $10/month (Basic, annual) or $14/month (monthly), per InstantDeco's own site",
      },
    ],
    lastUpdated: "2026-07-22",
  },
  ...
  },
  {
    ...
    comparisonRows: [
      ...
      },
      {
        ...
        easeOfUseText: "From $15/month (Studio plan)",
        pricing: "From $15/month (Studio plan, per RoomStudioAI's own site)",
      },
      {
        slug: "visualizee",
        styleRange: "~30 seconds (per Visualizee's own site)",
        ...
        easeOfUseText: "Free tier available (5 renders)",
        pricing: "Free tier (5 renders); Hobby from $15/month, per Visualizee's own site",
      },
    ],
    lastUpdated: "2026-07-22",
  },
