  ...
  // ── Architecture ────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "comparison-table",
        rows: [
          { tool: "Veras", category: "AI rendering", bestFor: "Architects already using Revit/SketchUp/Rhino", notes: "Widest BIM/CAD integration on the market" },
          ...
          { tool: "Midjourney", category: "AI image generation", bestFor: "Early mood boards, concept exploration", notes: "Not built for geometric accuracy" },
          { tool: "TestFit", category: "Generative planning", bestFor: "Multifamily, build-to-rent, parking-heavy projects", notes: "Real-time unit count & cost estimates" },
    ...
    content: [
      ...
      { type: "comparison-table",
        rows: [
          ...
          { tool: "Procore AI", category: "Project management", bestFor: "Firms already using Procore", notes: "AI layered into existing PM workflow" },
    ...
    content: [
      ...
      { type: "comparison-table",
        rows: [
          ...
          { tool: "Planner 5D", category: "Layout & space planning", bestFor: "Testing furniture arrangement and flow", notes: "2D/3D layout-first approach" },
          ...
          { tool: "Foyr Neo", category: "Professional 3D rendering", bestFor: "Final presentations, detailed renovation planning", notes: "Larger model library, more manual control" },
        ],
