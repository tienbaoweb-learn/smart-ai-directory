...
const ALL_TOOLS = [
  { name: "Vizcom",          slug: "vizcom",          logoBg: "bg-black",                                                              logoText: "VZ", rating: 4.8, bestFor: "Concept Design",          desc: "AI-powered concept design and visualization tool for architects.",                          pricingType: "Freemium", price: "From $X / month", category: "Architecture",    pricingTier: "Freemium" },
  { name: "Buildots",        slug: "buildots",        logoBg: "bg-orange-600",                                                         logoText: "BD", rating: 4.8, bestFor: "Construction Monitoring",desc: "AI-powered site monitoring and progress tracking for construction teams.",               pricingType: "Custom",   price: "From $X / month", category: "Construction",   pricingTier: "Paid"     },
  { name: "REimagineHome",   slug: "reimaginehome",   logoBg: "bg-purple-700",                                                         logoText: "RH", rating: 4.8, bestFor: "Real Estate Marketing",  desc: "AI tool to generate virtual staging and property visuals.",                                pricingType: "Freemium", price: "From $X / month", category: "Real Estate",    pricingTier: "Freemium" },
  { name: "Planner 5D",      slug: "planner5d",       logoBg: "bg-green-600",                                                          logoText: "P5", rating: 4.8, bestFor: "Interior Design",        desc: "All-in-one design and planning tool with AI for layout and interior design.",              pricingType: "Freemium", price: "From $6.99 / month",category: "Interior Design",pricingTier: "Freemium" },
  { name: "RoomGPT",         slug: "roomgpt",         logoBg: "bg-gray-900",                                                           logoText: "RG", rating: 4.7, bestFor: "Quick Concepts",         desc: "Generate interior ideas instantly from room photos using AI.",                              pricingType: "Freemium", price: "From $9.99 / month",category: "Interior Design",pricingTier: "Freemium" },
  { name: "Coohom",          slug: "coohom",          logoBg: "bg-blue-500",                                                           logoText: "C",  rating: 4.7, bestFor: "3D Visualization",       desc: "Professional 3D design and rendering platform for all interior projects.",                  pricingType: "Free Plan",price: "From $15 / month",  category: "Interior Design",pricingTier: "Free"     },
  { name: "Autodesk Forma",  slug: "autodesk-forma",  logoBg: "bg-gray-900",                                                           logoText: "AF", rating: 4.7, bestFor: "Site Analysis",          desc: "AI-powered site analysis and early-stage design tool for architects.",                      pricingType: "Freemium", price: "From $X / month", category: "Architecture",   pricingTier: "Freemium" },
  { name: "OpenSpace",       slug: "openspace",       logoBg: "bg-gray-900",                                                           logoText: "OS", rating: 4.7, bestFor: "Site Documentation",     desc: "Automatically capture and organize site photos for construction projects.",                  pricingType: "Custom",   price: "From $X / month", category: "Construction",   pricingTier: "Paid"     },
  { name: "Offrs",           slug: "offrs",           logoBg: "bg-emerald-600",                                                        logoText: "OF", rating: 4.7, bestFor: "Lead Generation",        desc: "AI-powered lead generation and prediction for real estate agents.",                         pricingType: "Custom",   price: "From $X / month", category: "Real Estate",    pricingTier: "Paid"     },
  { name: "Midjourney",      slug: "midjourney",      logoBg: "bg-black",                                                              logoText: "MJ", rating: 4.6, bestFor: "Visualization",          desc: "AI image generation tool widely used for architectural visualization.",                     pricingType: "Freemium", price: "From $X / month", category: "Architecture",   pricingTier: "Freemium" },
  { name: "Homestyler",      slug: "homestyler",      logoBg: "bg-gradient-to-br from-red-400 via-yellow-400 to-green-400",            logoText: "H",  rating: 4.6, bestFor: "Homeowners",             desc: "User-friendly 3D interior design tool with AI and a huge model library.",                   pricingType: "Freemium", price: "From $4.90 / month",category: "Interior Design",pricingTier: "Freemium" },
  { name: "Foyr Neo",        slug: "foyrneo",         logoBg: "bg-gray-900",                                                           logoText: "FN", rating: 4.6, bestFor: "Professionals",           desc: "AI-powered interior design software with photorealistic renders.",                          pricingType: "—",        price: "From $30 / month",  category: "Interior Design",pricingTier: "Paid"     },
];
