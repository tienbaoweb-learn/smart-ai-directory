          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            {TOP_PICKS.map((tool) => (
              <div key={tool.name} className="border border-gray-100 rounded-xl p-4 bg-white relative flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-xs text-[#2d5cf3] font-medium mt-1">{tool.bestFor}</p>
                ...
                <div className="flex flex-row gap-2 mt-3 w-full">
                  <Link
                    href={tool.href}
                    className="flex-1 text-center bg-[#2d5cf3] hover:bg-[#2447c2] text-white text-xs font-medium px-2 py-1.5 rounded-md transition-colors whitespace-nowrap"
                  >
                    Read Review →
                  </Link>
                  <a
