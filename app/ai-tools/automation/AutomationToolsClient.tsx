...
const CATEGORY_TOOLS = ALL_TOOLS.filter((t) => t.category === "automation");
    ...
    <div className="bg-gray-50 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <nav className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-[#1E293B] font-medium">AI Automation &amp; Workflow</span>
        </nav>
      </div>
    </div>
  );
    ...
    <section className="bg-white pt-12 pb-10 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1E293B] leading-tight mb-4 max-w-3xl">
          AI{" "}
          <span
            style={{ background: "linear-gradient(90deg, #F97316 0%, #FBBF24 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}
          >
            Automation &amp; Workflow
          </span>{" "}
          Tools
        ...
        <p className="text-gray-500 text-base sm:text-lg max-w-2xl mb-8 leading-relaxed">
          Discover AI tools for process automation, project tracking, site monitoring, and workflow optimization — built for furniture, architecture, construction, and real estate businesses.
        </p>
        ...
        >
          <div className="flex-1 flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus-within:border-orange-300 transition-colors">
            ...
            <input
              ...
              placeholder="Search automation tools (e.g. workflow, tracking, BIM automation...)"
