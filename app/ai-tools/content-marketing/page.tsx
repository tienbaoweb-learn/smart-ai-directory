    ...
    <section className="bg-white pt-12 pb-10 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1E293B] leading-tight mb-4 max-w-3xl">
          AI{" "}
          <span
            style={{ background: "linear-gradient(90deg, #9333EA 0%, #F97316 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}
          >
            Content &amp; Marketing
          </span>{" "}
          Tools
        ...
        <p className="text-gray-500 text-base sm:text-lg max-w-2xl mb-8 leading-relaxed">
          Discover AI tools for writing, content creation, ad copy, social media, and lead-generating marketing campaigns — built for furniture, architecture, construction, and real estate businesses.
        </p>
        ...
        <div className="flex gap-3 mb-5 max-w-[610px]">
          <div className="flex-1 flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus-within:border-orange-300 transition-colors">
            ...
            <input
              ...
              placeholder="Search content & marketing tools (e.g. copywriting, social media, ads...)"
...
const COMPARE_SLOTS = [
  { name: "ChatGPT",  bg: "bg-[#10A37F]",  initials: "GP" },
  { name: "Copy.ai",  bg: "bg-purple-600", initials: "CP" },
  { name: "Jasper",   bg: "bg-orange-500", initials: "JS" },
];

const TRENDING_PAIRS = [
  {
    a: { name: "ChatGPT",        bg: "bg-[#10A37F]",  initials: "GP" },
    b: { name: "Jasper",         bg: "bg-orange-500", initials: "JS" },
  },
  {
    a: { name: "Copy.ai",        bg: "bg-purple-600", initials: "CP" },
    b: { name: "Canva AI",       bg: "bg-[#00C4CC]",  initials: "CA" },
  },
  {
    a: { name: "Adobe Firefly",  bg: "bg-red-600",    initials: "AF" },
    b: { name: "Pixelcut",       bg: "bg-indigo-500", initials: "PX" },
  },
];
