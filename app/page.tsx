  ...
  return (
    <section id="newsletter" className="py-10 sm:py-14 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-8 px-8 sm:px-12 py-10" style={{ background: 'linear-gradient(to right, #1062B1 0%, #00B4D8 35%, #F5A623 70%, #E84C3D 100%)' }}>
