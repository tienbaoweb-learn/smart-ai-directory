            ...
            {TOP_TOOLS.map((tool) => (
              <div key={tool.name} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-2">
                  ...
                  <a href="#" className="flex-1 text-center text-xs font-semibold text-white bg-orange-500 hover:bg-orange-600 rounded-lg px-3 py-2 transition-colors whitespace-nowrap">
                    Visit Website →
                  </a>
                </div>
