    ...
    <section className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
          ...
          <a href="/resources/case-studies" className="text-sm font-semibold text-[#6484A4] hover:text-[#6484A4] transition-colors shrink-0">
          ...
          {CASE_STUDIES.map((cs) => (
            <div key={cs.company} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div className="p-5">
                ...
                <a href="/resources/case-studies" className="text-xs font-semibold text-[#6484A4] hover:text-[#6484A4] transition-colors">
                  Read Story →
                </a>
              </div>
            </div>
    ...
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
          ...
          <a href="/best-of" className="text-sm font-semibold text-[#6484A4] hover:text-[#6484A4] transition-colors shrink-0">
