        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="relative">
              <select className="appearance-none bg-white border border-gray-200 rounded-lg text-sm font-semibold text-[#1E293B] pl-3 pr-8 py-2 focus:outline-none focus:ring-2 focus:ring-blue-600/30 cursor-pointer">
              ...
              <div key={tool.name} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex gap-4">
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-2 min-w-[140px]">
                    ...
                    <a href="#" className="w-full text-center text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg px-3 py-2 transition-colors">
                      Visit Website →
                    </a>
